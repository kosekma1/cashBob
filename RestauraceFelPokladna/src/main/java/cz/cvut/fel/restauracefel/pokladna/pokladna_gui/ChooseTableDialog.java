...
public class ChooseTableDialog extends AbstractDialog {
     ...
     */
    public ChooseTableDialog(MainFrame parent, boolean modal, JTextField target) throws EmptyListException, RemoteException, NotBoundException, FileNotFoundException {
        super(parent, modal);
        this.target = target;
        initComponents();
