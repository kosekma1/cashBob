...
public class KeyboardDialog extends javax.swing.JDialog {
    ...
    public void setKeyStrokes() {
        ...
        for (int i=0; i<jButtons.length; i++) jButtons[i].addKeyListener(keyListener);
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Obrazová klávesnice");

        jLabel2.setText("Pro ukončení psaní na klávesnici klikněte na tlačítko OK");
    ...
    private void keypressed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_keypressed
        this.text.setText(this.text.getText()+((JButton)evt.getSource()).getText());
    }//GEN-LAST:event_keypressed

    private void jButtonDELActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDELActionPerformed
        String a = this.text.getText();
        if (a.length() == 0) {
            return;
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                KeyboardDialog dialog = new KeyboardDialog(new javax.swing.JFrame(), true);
...
class MyKeyListener implements KeyListener {
    ...
    /**
     * Konstruktor tridy MyKeyListener
     *
     * @param keyboard odkaz na KeyboardDialog volajici tuto tridu
     */
    public MyKeyListener(KeyboardDialog keyboard) {
        this.keyboard = keyboard;
    }

    public void keyTyped(KeyEvent e) {
        String puvodni = keyboard.text.getText();
        int znak = (int) e.getKeyChar();
        if ((znak >= 65 && znak <= 122)||(znak >= 48 && znak <= 57)) {
            keyboard.text.setText((puvodni + e.getKeyChar()).toUpperCase());
        } else if (znak == 32) { // space
            if (!keyboard.jButtonSPACE.hasFocus()) {
                keyboard.jButtonSPACE.requestFocus();
                keyboard.text.setText(puvodni + " ");
            }
        } else if (znak == 127) { // delete
            if (puvodni.length() == 0) return;
            keyboard.text.setText(puvodni.substring(0, puvodni.length()-1));
