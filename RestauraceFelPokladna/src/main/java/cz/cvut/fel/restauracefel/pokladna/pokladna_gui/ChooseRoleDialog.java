...
/**
 * Trida vytvarejici dialog pro vyber uzivatelske role.
 *
...
public class ChooseRoleDialog extends AbstractDialog {
    ...
    /**
     * Metoda provadi aktualizaci seznamu vsech uzivatelskych roli.
     *
     * @throws java.rmi.RemoteException
     * @throws java.rmi.NotBoundException
     * @throws java.io.FileNotFoundException
    ...
    protected void refresh() throws EmptyListException, RemoteException, NotBoundException, FileNotFoundException {
        String[] roles = ServiceFacade.getInstance().getRoleNames();
        if (roles==null) throw new EmptyListException("Žádné uživatelské role", "V systému nejsou momentálně evidovány žádné uživatelské role.");
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Kliknutím vyberete požadovanou uživatelskou roli");
