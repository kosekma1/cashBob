...
public class ChooseEmployeeDialog extends AbstractDialog {
     ...
     */
    public ChooseEmployeeDialog(MainFrame parent, boolean modal, JTextField target) throws EmptyListException, RemoteException, NotBoundException, FileNotFoundException {
        super(parent, modal);
        this.target = target;
        initComponents();
