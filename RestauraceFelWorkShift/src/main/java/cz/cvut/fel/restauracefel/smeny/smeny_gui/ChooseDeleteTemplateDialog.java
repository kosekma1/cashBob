 ...
 */
public class ChooseDeleteTemplateDialog extends AbstractDialog {
     ...
     */
    public ChooseDeleteTemplateDialog(MainFrame parent, boolean modal, JTextField target) throws EmptyListException, RemoteException, NotBoundException, FileNotFoundException {
        super(parent, modal);
        this.target = target;
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Smazat šablonu");

        jLabel2.setText("Kliknutím smažete šablonu");
