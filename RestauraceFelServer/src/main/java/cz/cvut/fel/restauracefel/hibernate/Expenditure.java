 ...
 */
public class Expenditure extends DBEntity {
    ...
    public static Expenditure findById(Integer id) {
        //return (Expenditure) findById("Expenditure", "expenditureId", id);
        return (Expenditure) findByIdNotDeleted("Expenditure", "expenditureId", id, "isDeleted", 0);
    }    

    //vrati vsechny vydeje, ktere nejsou oznaceny jako smazane
    public static List findAll(){
        return findAllNotDeleted("Expenditure", "isDeleted", 0);
    }


    public static List findByMaterial(Integer materialId) {
        String query = "from Expenditure ex where ex.material.materialId = :id1 and ex.isDeleted = :id2";
    ...
    public static List findByUser(Integer userId){
        String query = "from Expenditure ex where ex.user.userId = :id1 and ex.isDeleted = :id2";
		String[] paramNames = new String[] {"id1", "id2"};
		String[] paramTypes = new String[] {"Integer", "Integer"};
