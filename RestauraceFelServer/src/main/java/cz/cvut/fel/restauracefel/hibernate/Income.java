 ...
 */
public class Income extends DBEntity {
    ...
    public static Income findById(Integer id) {
        //return (Income) findById("Income", "incomeId", id);
        return (Income) findByIdNotDeleted("Income", "incomeId", id, "isDeleted", 0);
    }

    //vrati vsechny prijmy na sklad, ktere nejsou oznaceny jako smazane
    public static List findAll(){
        return findAllNotDeleted("Income", "isDeleted", 0);
    }

    public static List findByMaterial(Integer materialId){
        String query = "from Income inc where inc.material.materialId = :id1 and inc.isDeleted = :id2";
    ...
    public static List findByUser(Integer userId){
        String query = "from Income inc where inc.user.userId = :id1 and inc.isDeleted = :id2";
		String[] paramNames = new String[] {"id1", "id2"};
		String[] paramTypes = new String[] {"Integer", "Integer"};
