...
public class Workshift extends DBEntity implements java.io.Serializable {
    ...
    public static List getAllActiveWorkShifts(Date dateFrom){
        String[] paramNames = {"date_shift"};
        String[] paramTypes = {"Date"};
        Object[] paramValues = {dateFrom};
        
        String className = "Workshift";                
        String paramName = "dateShift";

        // POZOR, tady parametrem neni nazev tabulky a sloupecku, ale nazev tridy a jejich atributu
        List res = executeQuery("from " + className + " x where x." + paramName + " >= :date_shift", paramNames, paramTypes, paramValues);
